...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.cors()
                ...
                .antMatchers("/api/brand/**").hasAnyAuthority("ADMIN", "EDITOR", "MEZZ")
                .antMatchers("/api/ingredient/**").hasAnyAuthority("ADMIN", "EDITOR", "MEZZ")
                ...
                .antMatchers("/api/fried/**").hasAnyAuthority("USER", "ADMIN", "EDITOR", "MEZZ")
